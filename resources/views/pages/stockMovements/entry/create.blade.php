...
<div class="container-fluid">
    ...
    <div class="p-3 mt-2 rounded shadow-sm mb-2 bg-white">
        ...
        <form action="{{ route('stockMovements.entry.store') }}" method="post" class="row" enctype="multipart/form-data">
            ...
            <div class="col-6 mb-3">
                <label for="invoice_number" class="form-label text-dark font-weight-bold mt-2">Número da Nota Fiscal:</label>
                <input type="text" id="invoice_number" name="invoice_number" value="{{ old('invoice_number') }}" class="form-control" placeholder="Digite o número da nota fiscal" required>
            </div>

            <div class="col-6 mb-3">
                <label for="supplier" class="form-label text-dark font-weight-bold mt-2">Fornecedor:</label>
                <input type="text" id="supplier" name="supplier" value="{{ old('supplier') }}" class="form-control" placeholder="Digite o nome do fornecedor" required>
            </div>
            ...
            <div class="col-6 d-flex gap-2 mt-2" id="buttonContainer">
                ...
                <a href="{{ route('stockMovements.entry.index') }}" class="btn btn-golden-rounded fw-semibold mx-2">Voltar</a>
            </div>
        </form>
    </div>
</div>
