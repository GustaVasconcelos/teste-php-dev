...
@section('title', 'Movimentos de Estoque | Saída')
...
<div class="container-fluid">
    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1 text-dark">
        Movimentos de estoque <i class="fas fa-chevron-right mx-1"></i> Saída
    </div>
    ...
    <div class="mt-4 d-flex justify-content-between align-items-center flex-wrap">
        ...
        <div>
            <a href="{{ route('stockMovements.exit.create') }}" class="btn btn-golden-rounded fw-semibold mx-2">Nova Saída</a>
        </div>
    </div>

    <form class="p-3 mt-2 rounded shadow-sm mb-2 bg-white" action="{{ route('stockMovements.exit.index') }}" method="GET">
        ...
        <div class="d-flex flex-wrap gap-2 mt-2">
            ...
            <a href="{{ route('stockMovements.exit.index') }}" class="btn btn-golden-rounded fw-semibold mx-2">
                Limpar filtros
            </a>
        </div>
    </form>
    ...
    <div class="p-3 mt-2 rounded-3 bg-white">
        <table class="table table-striped">
            ...
            <tbody>
                ...
                @else
                    <tr>
                        <td colspan="6" class="text-center">Não há movimentos de saída de estoque cadastrados.</td>
                    </tr>
                @endif
            </tbody>
        </table>
