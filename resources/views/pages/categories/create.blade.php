...
<div class="container-fluid">
    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1 text-dark">
        Categorias <i class="fas fa-chevron-right mx-1"></i> Cadastro
    </div>
    ...
    <div class="p-3 mt-2 rounded shadow-sm mb-2 bg-white">
        ...
        <form action="{{ route('categories.store') }}" method="post" class="row" enctype="multipart/form-data">
            ...
            <div class="col-12 mb-3">
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-control" placeholder="Digite o nome da categoria">
            </div>
